...
$createTableSql="CREATE TABLE IF NOT EXISTS DeviceInfo(ID int(10) unsigned NOT NULL AUTO_INCREMENT, STATUS char(30) NOT NULL, IP char(30) NOT NULL, MAC char(30) NOT NULL, NATTYPE char(30) NOT NULL, NAT char(30) NOT NULL, TUNNEL int(10), PRIMARY KEY(ID))";
...
if($numRows==0)
{
    ...
    $insertSql="INSERT INTO DeviceInfo values('', '$_POST[STATUS]', '$_POST[IP]', '$_POST[MAC]', '$_POST[NATTYPE]', '$_POST[NAT]', '$_POST[TUNNEL]')";
    $db->Query($insertSql);
...
else if($numRows==1)
{
    ...
    $updateSql="UPDATE DeviceInfo SET STATUS='$_POST[STATUS]', IP='$_POST[IP]', NATTYPE='$_POST[NATTYPE]', NAT='$_POST[NAT]', TUNNEL='$_POST[TUNNEL]' WHERE MAC='$_POST[MAC]'";
    $db->Query($updateSql);
    $affectedRows=mysql_affected_rows();
